...
# constants
defaultGreen = {0:8, 1:5, 2:3, 3:10} # hard time data, light# : green light time
defaultRed = 150 # set to 150 to never turn green, resets to 150 in the "repeat" section
defaultYellow = 3 # yellow light time
signals = []
noOfSignals = 4
currentGreen = 0
nextGreen = (currentGreen +1)%noOfSignals
currentYellow = 0 
speeds = {'car':2.25, 'bus':1.8, 'truck':1.8, 'bike':2.5}# add more vehicles + speeds here

# coordinates - vehicle start
...
def showStats():
    ...
    print(f'Total time: {timeElapsed}')
